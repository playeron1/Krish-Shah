...
var LINES = (function () {
    ...
    var offset = function (anchor) {
        anchor = anchor || this;
        var x, y;
        var rect2 = anchor.el.getBoundingClientRect();

        var rect = $(anchor.el).position();
    ...
    var draw = function (line) {
        ...
        if (line._bleed) {
            ...
            width = width + line._stroke - line._less;
        }
    ...
    var Line = function (anchor1, anchor2, properties) {
        ...
        this._less = (typeof properties._less === 'number') ? properties._less : 2;
        this.parent = (typeof properties.parent === 'string') ? properties.parent : 'body';
        this._bleed = (typeof properties.bleed === 'boolean') ? properties.bleed : true;
        this._name = (typeof properties.name === 'string') ? properties.name : '';
        this._state = (typeof properties.state === 'string') ? properties.state : '';
        this.type = (typeof properties.type === 'number') ? properties.type : 1;
